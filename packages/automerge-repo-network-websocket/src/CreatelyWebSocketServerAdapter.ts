import { WebSocketServerAdapter as BaseAdapter } from './WebSocketServerAdapter.js';
...
export type MessageHandler<X, M = Message> = (
    ...
    context: CreatelyWebSocketServerAdapter<X> // thisArg
) => void;
...
export class CreatelyWebSocketServerAdapter<T> extends BaseAdapter {
    peerIdentity: {
        [peerId: PeerId]: T
    } = {};
    authTokens: {
